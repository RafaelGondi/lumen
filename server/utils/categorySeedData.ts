...
export const seedSupercategories: SeedSupercategory[] = [
  ...
  { name: 'Carro', color: '#4d3f9c', icon: 'car' },
...
export const seedCategories: SeedCategory[] = [
  // Receitas
  { name: 'Ajuste (entrada)', type: 'income', color: '#4d3f9c', icon: 'circle-dollar', supercategory: null },
  ...
  { name: 'Freela', type: 'income', color: '#4d3f9c', icon: 'briefcase', supercategory: null },
  ...
  { name: 'Ajuste de contas em grupo (saída)', type: 'expense', color: '#4d3f9c', icon: 'handshake', supercategory: null },
  ...
  { name: 'Bebida', type: 'expense', color: '#924e2f', icon: 'coffee', supercategory: null },
  ...
  { name: 'Curso', type: 'expense', color: '#4d3f9c', icon: 'graduation-cap', supercategory: null },
  ...
  { name: 'Financiamento do carro', type: 'expense', color: '#4d3f9c', icon: 'car', supercategory: 'Carro' },
  ...
  { name: 'Internet', type: 'expense', color: '#4d3f9c', icon: 'wifi', supercategory: 'Casa' },
  ...
  { name: 'Lava-jato', type: 'expense', color: '#4d3f9c', icon: 'droplet', supercategory: 'Carro' },
  ...
  { name: 'Moradia', type: 'expense', color: '#924e2f', icon: 'house', supercategory: 'Casa' },
  ...
  { name: 'Terapia', type: 'expense', color: '#4d3f9c', icon: 'brain', supercategory: 'Saúde' },
